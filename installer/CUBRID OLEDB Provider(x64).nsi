...
; The file to write
;OutFile "CUBRID OLE DB Data Provider 9.0.0 (x32).exe"
...
InstallDir "$PROGRAMFILES64\CUBRID\CUBRID OLE DB Data Provider 9.0.0 (x64)"

; Registry key to check for installation directory
InstallDirRegKey HKLM "Software\CUBRID\CUBRID OLE DB Data Provider 9.0.0 (x64)" "Install_Dir"
...
Section "CUBRID OLE DB Data Provider Files" DataProviderFiles
  ...
  File "/oname=$OUTDIR\CUBRIDProvider.dll" "..\Source\x64\Release\CUBRIDProvider.dll"
  ...
  WriteRegStr HKLM "SOFTWARE\CUBRID\CUBRID OLE DB Data Provider 9.0.0 (x64)" "Install_Dir" "$INSTDIR"
  
  ; Write the uninstall information
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\CUBRID OLE DB Data Provider 9.0.0 (x64)" "DisplayName" "CUBRID OLE DB Data Provider 9.0.0 (x64)"
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\CUBRID OLE DB Data Provider 9.0.0 (x64)" "UninstallString" '"$INSTDIR\uninstall.exe"'
  WriteRegDWORD HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\CUBRID OLE DB Data Provider 9.0.0 (x64)" "NoModify" 1
  WriteRegDWORD HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\CUBRID OLE DB Data Provider 9.0.0 (x64)" "NoRepair" 1
...
Section "Start Menu shortcuts" DataProviderShortcuts
  ...
  CreateDirectory "$SMPROGRAMS\CUBRID\CUBRID OLE DB Data Provider 9.0.0 (x64)"
  CreateShortCut "$SMPROGRAMS\CUBRID\CUBRID OLE DB Data Provider 9.0.0 (x64)\Uninstall.lnk" "$INSTDIR\uninstall.exe" "" "$INSTDIR\uninstall.exe" 0
...
Section "Uninstall"
  ...
  Delete "$SMPROGRAMS\CUBRID\CUBRID OLE DB Data Provider 9.0.0 (x64)\Uninstall.lnk"

  RMDir /r "$SMPROGRAMS\CUBRID\CUBRID OLE DB Data Provider 9.0.0 (x64)"
  RMDir "$SMPROGRAMS\CUBRID"

  ; Remove registry keys
  DeleteRegKey HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\CUBRID OLE DB Data Provider 9.0.0 (x64)"
  DeleteRegKey HKLM "SOFTWARE\CUBRID\CUBRID OLE DB Data Provider 9.0.0 (x64)"
