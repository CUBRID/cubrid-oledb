...
copy %CCI_WIN_DIR%\Win32\Release\cas_cci.lib  %INSTALL_DIRS%\lib32\cas_cci.lib
copy %CCI_WIN_DIR%\Win32\Debug\cas_cci.lib  %INSTALL_DIRS%\lib32\cas_cci_d.lib
copy %CCI_WIN_DIR%\x64\Release\cas_cci.lib  %INSTALL_DIRS%\lib64\cas_cci.lib
copy %CCI_WIN_DIR%\x64\Debug\cas_cci.lib  %INSTALL_DIRS%\lib64\cas_cci_d.lib
